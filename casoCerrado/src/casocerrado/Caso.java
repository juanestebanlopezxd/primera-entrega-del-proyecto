...
public class Caso {
    ...
    public Caso(int numeroCaso, String descripCaso, String codigoDePrioridad, String nombClave, String tipocaso, Detective detective, Bitacora bitacora, Sospechoso sospechoso) {
        this.numeroCaso = numeroCaso;
        this.descripCaso = descripCaso;
        this.codigoDePrioridad = codigoDePrioridad;
        this.nombClave = nombClave;
